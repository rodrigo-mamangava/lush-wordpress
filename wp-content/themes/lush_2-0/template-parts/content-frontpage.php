    ...
    <div class="container">
        ...
        <div>
            <div class="row">
                ...
                <?php
                faixa_destaque_par(
                        get_field('faixa_destaque_01_foto'), get_field('faixa_destaque_01_icone'), get_field('faixa_destaque_01_titulo'), get_field('faixa_destaque_01_texto'), '#', 'View Experiences'
                );

                faixa_destaque_impar(
                        get_field('faixa_destaque_02_foto'), get_field('faixa_destaque_02_icone'), get_field('faixa_destaque_02_titulo'), get_field('faixa_destaque_02_texto'), '#', 'Explore menu'
                );
                ?>

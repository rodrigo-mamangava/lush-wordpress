 ...
 */         
            ...
            function displayTextInput($args = array()){
                ...
                array_push($html, '     <input type="text" name="DOPBSP-discount-'.$id.'" id="DOPBSP-discount-'.$id.'" value="'.$value.'" onkeyup="if ((event.keyCode||event.which) !== 9){DOPBSPBackEndDiscount.edit(\'text\', \''.$id.'\', this.value);}" onpaste="DOPBSPBackEndDiscount.edit(\'text\', \''.$id.'\', this.value)" onblur="DOPBSPBackEndDiscount.edit(\'text\', \''.$id.'\', this.value, true)" />');
            ...
            function displaySwitchInput($args = array()){
                ...
                array_push($html, '         <input type="checkbox" name="DOPBSP-discount-'.$id.'-'.$discount_id.'" id="DOPBSP-discount-'.$id.'-'.$discount_id.'" class="dopbsp-switch-checkbox" onchange="DOPBSPBackEndDiscount.edit(\'switch\', \''.$id.'\')"'.($value == 'true' ? ' checked="checked"':'').' />');

					...
					<div class="booking_data_column">
						...
						<p class="form-field form-field-wide">
							...
							<?php else : 
								...
								$guest_place_holder = sprintf( _x( 'Guest(%s)', 'Guest string with name from booking order in brackets', 'woocommerce-bookings' ), $guest_name );
							?>
								<input type="hidden" class="wc-customer-search" id="_booking_customer_id" name="_booking_customer_id" data-placeholder="<?php echo esc_attr( $guest_place_holder ); ?>" data-selected="<?php echo esc_attr( $user_string ); ?>" value="<?php echo $customer_id; ?>" data-allow_clear="true" />
							<?php endif; ?>
						</p>

<div id="bookings_persons" class="woocommerce_options_panel panel wc-metaboxes-wrapper">
	...
	<div class="options_group" id="persons-options">
		...
		<?php woocommerce_wp_checkbox( array( 'id' => '_wc_booking_person_qty_multiplier', 'label' => __( 'Count persons as bookings', 'woocommerce-bookings' ), 'description' => __( 'Enable this to count each person as a booking until the max bookings per block (in availability) is reached.', 'woocommerce-bookings' ), 'desc_tip' => true, 'value' => get_post_meta( $post_id, '_wc_booking_person_qty_multiplier', true ) ) ); ?>

...
<div class="booking_variation_data show_if_variation_bookable">
    ...
    <?php $number_of_dates = $variation->_booking_dates; ?>
    ...
    <div class="show_if_two_dates">
        ...
        <?php $selected_duration = $variation->_booking_duration; ?>
        <p class="form-row form-row-first">
        ...
        <p class="form-row form-row-last custom_booking_duration_field">
            ...
            <input type="number" class="input_text custom_booking_duration" min="1" max="366" name="_var_custom_booking_duration[<?php echo $loop; ?>]" id="_var_custom_booking_duration[<?php echo $loop; ?>]" placeholder="<?php _e( 'Same as parent', 'woocommerce' ) ?>" value="<?php if ( isset( $variation->_custom_booking_duration ) ) echo esc_attr( $variation->_custom_booking_duration ); ?>" />
        ...
        <p class="form-row form-row-first">
            ...
            <input type="number" class="input_text booking_min" min="0" name="_var_booking_min[<?php echo $loop; ?>]" id="_var_booking_min[<?php echo $loop; ?>]" placeholder="<?php _e( 'Same as parent', 'woocommerce' ) ?>" value="<?php if ( isset( $variation->_booking_min ) ) echo esc_attr( $variation->_booking_min ); ?>" />
        ...
        <p class="form-row form-row-last">
            ...
            <input type="number" class="input_text booking_max" min="0" name="_var_booking_max[<?php echo $loop; ?>]" id="_var_booking_max[<?php echo $loop; ?>]" placeholder="<?php _e( 'Same as parent', 'woocommerce' ) ?>" value="<?php if ( isset( $variation->_booking_max ) ) echo esc_attr( $variation->_booking_max ); ?>" />
    ...
    <p class="form-row form-row-first">
        ...
        <input type="number" class="input_text" min="0" name="_var_first_available_date[<?php echo $loop; ?>]" id="_var_first_available_date[<?php echo $loop; ?>]" placeholder="<?php _e( 'Same as parent', 'woocommerce' ) ?>" value="<?php if ( isset( $variation->_first_available_date ) ) echo esc_attr( $variation->_first_available_date ); ?>" />
